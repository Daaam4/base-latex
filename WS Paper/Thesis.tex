...
\subsection{SysML v2: Formal Verification via Constraint Satisfaction} %{ Molanr, Ratzke }
...
By applying constraint propagation algorithms to this model, the solver actively reduces the design space. Restricting the valid domains of the dimensional attributes (width, height, length), verifying that only those values capable of satisfying the tankBigEnough requirement remain. This constitutes a formal verification of the design solution against its technical requirements, achieved entirely through the intrinsic semantics of SysML v2 \cite{ratzke,molnar}.
