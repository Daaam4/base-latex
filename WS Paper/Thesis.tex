...
\subsection{The Shift from Extrinsic to Intrinsic Verification}
\subsection{Eliminating the Model Transformation Gap}
\subsection{Scalability and complexity}
\subsection{Compliance upon inspection vs. Compliance by definition} %{ Cibrián }
