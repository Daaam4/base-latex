...
\begin{itemize}
    ...
    \item \textbf{Cases}: SysML v2 introduced a generic \textit{Case} construct that can declare a subject and an objective to provide a formal and executable way to check model correctness and evaluate system properties \cite{molnar}. Two specialized cases are provided \textit{Analysis Case} (Quantative Analysis) and \textit{Verification Case} (Qualitative Analysis), further enhacing model analysis capabilities \cite{molnar}.
\end{itemize}
