...
\usepackage[german]{babel} % language: germen
...
\usepackage[left=2.0cm,right=2.0cm,top=2.5cm,bottom=2.5cm,head=22pt,foot=22pt]{geometry} 
\usepackage{url}
...
\begin{document}
    ...
    % Pages
    \include{./doc/101motivation} % Motivation
    \include{./doc/102planarität} % Einführung in die Planarität
    \include{./doc/103kuratowski} % Satz 6.14 Kuratowski 1930
