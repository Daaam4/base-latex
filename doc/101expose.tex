...
This approach relies on standardized frameworks like Systems Modeling Language (SysML) to model discipline-specific subsystems in a central model. \cite{boelsen, zirui, dehn, cibrian, yildirim,friedenthal,jansen, beers}
However, the flexibility of SysML leads to inconsistencies, non-reusable models, making modeling guidelines essential for ensuring quality, consistency, and reusability in MBSE practices. \cite{boelsen,zirui,cibrian, yildirim} \\
The introduction of SysML v2 is intended to enhance MBSE adoption over its predecessor. \cite{friedenthal}
SysML v2's new features - particularly its textual syntax , formal metamodel, and standardized API - aim at improving precision, expressiveness, usability, interoperability, and extensibility. \cite{boelsen, zirui, cibrian, friedenthal, jansen} \\
...
\begin{itemize}
    ...
    \item \textbf{Hypothesis 2 (Opportunity - Validation):} The v2 metamodel allows for automated semantic and syntactic consistency checking, moving guidelines from passive documents to active, verifiable parts of the model. \cite{cibrian}
