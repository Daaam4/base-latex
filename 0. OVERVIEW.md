...
- [ ] **MSoSA version** — is a newer build available than the seminar's **2024x Refresh2 HF1**? Ask specifically for **2026x Refresh1** (current latest), or at least **2024x Refresh3**.
