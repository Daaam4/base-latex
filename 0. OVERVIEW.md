...
2. ~~1 LLM family instead of 2–3~~ → **already the plan** (D9); the remaining lever is 1 model tier instead of 2
...
- [ ] Rigour expectation: well-argued framework + pilot evaluation, or statistically solid results (pass^k, multiple models)?
